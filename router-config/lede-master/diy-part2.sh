...
sed -i "s|DISTRIB_REVISION='.*'|DISTRIB_REVISION='V.$(date +%Y.%m.%d)'|g" package/lean/default-settings/files/zzz-default-settings
echo "DISTRIB_SOURCECODE='lasthinker'" >>package/base-files/files/etc/openwrt_release
