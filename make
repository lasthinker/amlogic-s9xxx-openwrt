...
kernel_library="https://github.com/lasthinker/flippy-kernel/tree/main/library"
command_file="https://github.com/lasthinker/luci-app-amlogic/trunk/luci-app-amlogic/root/usr/bin"
...
Options:
    ...
    -u, --update           Whether to auto update to the latest kernel of the same series
      , -u true            Auto update to the latest kernel
